        ...
        if (userName) {
            const fetchThumbnails = async () => {
                ...
                try {
                    ...
                    setThumbnails(parsedBody.images);
                } catch (err) {
                ...
                <div className="album py-5 bg-light">
                    <div className="container">
                        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                            {Array.isArray(thumbnails) && thumbnails.map((image, index) => (
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
                                                   ...
                                                   /* UNCOMMENT
                                                   <a href={image.thumbnailUrl} className="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener noreferrer">View</a>
                                                </div>
                    ...
                    <div className="card-body">
                      <div className="d-flex justify-content-between align-items-center">
                        <div className="btn-group">
                          ...
                          <button className="btn btn-sm btn-outline-secondary" onClick={() => handleViewImage(url)}>View</button>
                        </div>
                        {copied && copiedIndex === index && <span style={{ color: 'green' }}>Copied!</span>}
                      </div>
                    </div>
